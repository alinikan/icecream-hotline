...
const FACTS = [
  ...
  { emoji: "🗣️", text: "حافظه خوبی داره وقتی بقیه یه چیزی میگن، ولی وقتی خودش به کسی چیزی میگه دیگه یادش نیست", category: "شخصیت" },
  { emoji: "🦟", text: "به پشه آلرژی داره", category: "زندگی" },
];
